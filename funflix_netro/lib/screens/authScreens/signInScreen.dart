                ...
                Center(
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: const Icon(
                          Icons.lock, color: AppColors.colorDisabled,
                        ),
                        hintText: 'Password',
                        hintStyle: const TextStyle(
                            color: AppColors.colorDisabled),
              ...
              const RememberMeModel(),
                ...
                InkWell(
                  onTap: () {
                    ...
                    //     context,
                    //     MaterialPageRoute(
                    //         builder: (context) => ForgotResetScreen()));
                  },
                  child: Text(
                    "Forget the password?",
                    textAlign: TextAlign.center,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Image.asset('assets/images/facebook.png', height: 32.h,
                      width: 32.w),
                    SizedBox(width: 10.w),
                    Image.asset('assets/images/google.png', height: 40.h,
                      width: 40.w),
                    Image.asset('assets/images/apple.png',height: 50.h,
                      width: 45.w),
                  ],
                ),
